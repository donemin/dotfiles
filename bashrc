...
alias vi="vim"
alias updateHost="~/scripts/hosts/updateHost.sh"
alias chost='~/scripts/hosts/changeHost.sh'
alias editHost='~/scripts/hosts/editHost.sh'
alias checkHost='~/scripts/hosts/currentHost.sh'
